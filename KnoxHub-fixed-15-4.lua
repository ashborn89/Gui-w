...
TabList.Size=UDim2.new(1,-10,1,-(196+85))   -- slightly more height than original (was 90)
...
-- ---- PROMO CARD — exactly fills the empty space between tab list and footer ----
-- TabList bottom = 196 + (H - 196 - 85) = H - 85 = 335
-- Footer top     = H - FOOT_H           = H - 30 = 390
-- Empty gap      = 335 to 390 = 55px, minus 4px top gap + 4px bottom gap = 47px card height
local TABLIST_BOTTOM = H - 85            -- where tab list ends
...
-- Patch top-left and top-right back to square (extend slightly for clean coverage)
do local f=Instance.new("Frame")
   f.Size=UDim2.new(1,0,0,CORNER+2); f.Position=UDim2.new(0,0,0,0)
